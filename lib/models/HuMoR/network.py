...
class Network(nn.Module):
    def __init__(self, ) :
        ...
        # Model
        self.motion_encoder = MotionEncoder(input_dim)
        self.humor = HumorModel()
    ...
    def init_batch(self, batch):
        ...
        if 'contact' in data :
            contact = batch['contact'].unsqueeze(-2)    # [T, B, 1, 2]
    ...
    def forward_smpl(self, batch):
        ...
        contact = compute_contact_label(c_kp3d_feet)    # [B, T, 2]
    ...
    def forward(self, batch):
        ...
        batch['w_orient_6d_tp'] = batch['w_orient_6d_tp'][1:]
        batch['w_orient_q_tp'] = batch['w_orient_q_tp'][1:]
        batch['contact_tp'] = batch['contact_tp'][1:]
